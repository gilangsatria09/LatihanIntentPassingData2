    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_object:
                Person p = new Person();
                p.setName("Gilang Satria");
                p.setAge(17);
                p.setEmail("gsatria253@gmail.com");
                p.setCity("Bandung");
                Intent moveWithObjectIntent = new Intent(MainActivity.this,MoveWIthObjectActivity.class);
                moveWithObjectIntent.putExtra(MoveWIthObjectActivity.EXTRA_PERSON,p);
                startActivity(moveWithObjectIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "081285207553";
